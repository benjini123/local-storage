...
var _principal = require("../page/principal");
var _state = require("./state");
(function() {
    _state.state.init();
    _principal.initPageWelcome(document.querySelector(".root"));
})();

},{"../page/principal":"yvlsg","../components/todo-item":"aVoNB","./state":"28XHA"}],"yvlsg":[function(require,module,exports) {
...
function initPageWelcome(params) {
    ...
    const containerEl = div.querySelector(".container");
    ...
    function createTasks(items) {
        ...
        for (const item of items){
            ...
            if (item.completed) postItEl.setAttribute("checked", "true");
            postItEl.addEventListener("change", (e)=>{
                console.log(e);
    ...
    div.querySelector(".button").addEventListener("click", (e)=>{
        e.preventDefault;
        _state.state.addTasks("desde el boton", Math.random());
    });
    params.appendChild(div);
    params.appendChild(style);
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","../../src/state":"28XHA"}],"JacNc":[function(require,module,exports) {
...
const state = {
    ...
    changeItemState (id, value) {
        const currentState = this.getState();
        const found = currentState.find((t)=>t.id == id
        );
        found.status = value;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"aVoNB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initPostItElement", ()=>initPostItElement
);
function initPostItElement() {
    customElements.define("post-it", class extends HTMLElement {
        constructor(){
            super();
            this.title = "";
            this.checked = false;
        ...
        render() {
            const div = document.createElement("div");
            div.innerHTML = `\n\n        <div class="container">\n          <h3 class="title ${this.checked ? "checked" : ""}">${this.title}</h3>\n          <input class="checkbox" type="checkbox" ${this.checked ? "checked" : ""}></input>\n        </div>\n        `;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["8uBhv","4aleK"], "4aleK", "parcelRequire385c")
